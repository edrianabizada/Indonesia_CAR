...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;93mBY *_EDRIS_* \033[91m:\033[1;96m ")
	if unikers =="":
...
def pilih_indo():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;97m{\033[1;93m➹\033[1;97m} EDRIS NABIZADA... "+o),;sys.stdout.flush();time.sleep(1)

	print "\n\033[1;31;1m=========================================="
        print "\n\033[1;96mEDRUS NABIZADA FB HACK"
        print "\n\033[1;33mBY *_EDRIS_*"
	print "\n\033[37;1m=========================================="
